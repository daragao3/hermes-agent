...
# Semantically "unbounded", but accepted by the actual threading primitives.
# Windows' _thread.TIMEOUT_MAX is about 49.7 days, far below one year; hardcoding
# the year still raises OverflowError in Lock.acquire(timeout=...).
from _thread import TIMEOUT_MAX as _THREAD_TIMEOUT_MAX

MAX_SAFE_TIMEOUT_S = min(31_536_000.0, float(_THREAD_TIMEOUT_MAX))
