...
# Local September 4 rate reconciliation retained during upstream integration.
# Existing upstream cache and whole-request tier fields are retained where local
# snapshots supplied no value. This is a merged historical snapshot, not a fresh rate check.
_OFFICIAL_DOCS_PRICING[('google', 'gemini-3.8-flash')] = replace(
    _OFFICIAL_DOCS_PRICING.get(('google', 'gemini-3.8-flash'), PricingEntry()), input_cost_per_million=Decimal("1.50"), output_cost_per_million=Decimal("7.50"), source="official_docs_snapshot", source_url="https://ai.google.dev/gemini-api/docs/pricing", pricing_version="google-pricing-2026-09-04",
)
_OFFICIAL_DOCS_PRICING[('google', 'gemini-3.7-flash')] = replace(
    _OFFICIAL_DOCS_PRICING.get(('google', 'gemini-3.7-flash'), PricingEntry()), input_cost_per_million=Decimal("1.50"), output_cost_per_million=Decimal("7.50"), source="official_docs_snapshot", source_url="https://ai.google.dev/gemini-api/docs/pricing", pricing_version="google-pricing-2026-09-04",
)
_OFFICIAL_DOCS_PRICING[('google', 'gemini-3.6-flash')] = replace(
    _OFFICIAL_DOCS_PRICING.get(('google', 'gemini-3.6-flash'), PricingEntry()), input_cost_per_million=Decimal("1.50"), output_cost_per_million=Decimal("7.50"), source="official_docs_snapshot", source_url="https://ai.google.dev/gemini-api/docs/pricing", pricing_version="google-pricing-2026-09-04",
)
_OFFICIAL_DOCS_PRICING[('google', 'gemini-3.5-flash')] = replace(
    _OFFICIAL_DOCS_PRICING.get(('google', 'gemini-3.5-flash'), PricingEntry()), input_cost_per_million=Decimal("1.50"), output_cost_per_million=Decimal("9.00"), source="official_docs_snapshot", source_url="https://ai.google.dev/gemini-api/docs/pricing", pricing_version="google-pricing-2026-09-04",
)
_OFFICIAL_DOCS_PRICING[('google', 'gemini-3.5-flash-lite')] = replace(
    _OFFICIAL_DOCS_PRICING.get(('google', 'gemini-3.5-flash-lite'), PricingEntry()), input_cost_per_million=Decimal("0.30"), output_cost_per_million=Decimal("2.50"), source="official_docs_snapshot", source_url="https://ai.google.dev/gemini-api/docs/pricing", pricing_version="google-pricing-2026-09-04",
)
_OFFICIAL_DOCS_PRICING[('google', 'gemini-3.1-flash-lite')] = replace(
    _OFFICIAL_DOCS_PRICING.get(('google', 'gemini-3.1-flash-lite'), PricingEntry()), input_cost_per_million=Decimal("0.25"), output_cost_per_million=Decimal("1.50"), source="official_docs_snapshot", source_url="https://ai.google.dev/gemini-api/docs/pricing", pricing_version="google-pricing-2026-09-04",
)
_OFFICIAL_DOCS_PRICING[('google', 'gemini-3.1-pro-preview')] = replace(
    _OFFICIAL_DOCS_PRICING.get(('google', 'gemini-3.1-pro-preview'), PricingEntry()), input_cost_per_million=Decimal("2.00"), output_cost_per_million=Decimal("12.00"), source="official_docs_snapshot", source_url="https://ai.google.dev/gemini-api/docs/pricing", pricing_version="google-pricing-2026-09-04",
)
_OFFICIAL_DOCS_PRICING[('google', 'gemini-3.1-pro')] = replace(
    _OFFICIAL_DOCS_PRICING.get(('google', 'gemini-3.1-pro'), PricingEntry()), input_cost_per_million=Decimal("2.00"), output_cost_per_million=Decimal("12.00"), source="official_docs_snapshot", source_url="https://ai.google.dev/gemini-api/docs/pricing", pricing_version="google-pricing-2026-09-04",
)
_OFFICIAL_DOCS_PRICING[('google', 'gemini-2.5-pro')] = replace(
    _OFFICIAL_DOCS_PRICING.get(('google', 'gemini-2.5-pro'), PricingEntry()), input_cost_per_million=Decimal("1.25"), output_cost_per_million=Decimal("10.00"), source="official_docs_snapshot", source_url="https://ai.google.dev/gemini-api/docs/pricing", pricing_version="google-pricing-2026-09-04",
)
_OFFICIAL_DOCS_PRICING[('google', 'gemini-2.5-flash')] = replace(
    _OFFICIAL_DOCS_PRICING.get(('google', 'gemini-2.5-flash'), PricingEntry()), input_cost_per_million=Decimal("0.30"), output_cost_per_million=Decimal("2.50"), source="official_docs_snapshot", source_url="https://ai.google.dev/gemini-api/docs/pricing", pricing_version="google-pricing-2026-09-04",
)
_OFFICIAL_DOCS_PRICING[('google', 'gemini-2.5-flash-lite')] = replace(
    _OFFICIAL_DOCS_PRICING.get(('google', 'gemini-2.5-flash-lite'), PricingEntry()), input_cost_per_million=Decimal("0.10"), output_cost_per_million=Decimal("0.40"), source="official_docs_snapshot", source_url="https://ai.google.dev/gemini-api/docs/pricing", pricing_version="google-pricing-2026-09-04",
)
_OFFICIAL_DOCS_PRICING[('moonshot', 'kimi-k3')] = replace(
    _OFFICIAL_DOCS_PRICING.get(('moonshot', 'kimi-k3'), PricingEntry()), input_cost_per_million=Decimal("3.00"), output_cost_per_million=Decimal("15.00"), cache_read_cost_per_million=Decimal("0.30"), source="official_docs_snapshot", source_url="https://platform.kimi.ai/docs/pricing/chat-k3", pricing_version="moonshot-pricing-2026-09-04",
)
_OFFICIAL_DOCS_PRICING[('moonshot', 'k3')] = replace(
    _OFFICIAL_DOCS_PRICING.get(('moonshot', 'k3'), PricingEntry()), input_cost_per_million=Decimal("3.00"), output_cost_per_million=Decimal("15.00"), cache_read_cost_per_million=Decimal("0.30"), source="official_docs_snapshot", source_url="https://platform.kimi.ai/docs/pricing/chat-k3", pricing_version="moonshot-pricing-2026-09-04",
)
_OFFICIAL_DOCS_PRICING[('moonshot', 'kimi-for-coding')] = replace(
    _OFFICIAL_DOCS_PRICING.get(('moonshot', 'kimi-for-coding'), PricingEntry()), input_cost_per_million=Decimal("3.00"), output_cost_per_million=Decimal("15.00"), cache_read_cost_per_million=Decimal("0.30"), source="official_docs_snapshot", source_url="https://platform.kimi.ai/docs/pricing/chat-k3", pricing_version="moonshot-pricing-2026-09-04",
)
_OFFICIAL_DOCS_PRICING[('moonshot', 'kimi-k2.7-code')] = replace(
    _OFFICIAL_DOCS_PRICING.get(('moonshot', 'kimi-k2.7-code'), PricingEntry()), input_cost_per_million=Decimal("0.95"), output_cost_per_million=Decimal("4.00"), cache_read_cost_per_million=Decimal("0.19"), source="official_docs_snapshot", source_url="https://platform.kimi.ai/docs/pricing/chat-k27-code", pricing_version="moonshot-pricing-2026-09-04",
)
_OFFICIAL_DOCS_PRICING[('moonshot', 'kimi-k2.7-code-highspeed')] = replace(
    _OFFICIAL_DOCS_PRICING.get(('moonshot', 'kimi-k2.7-code-highspeed'), PricingEntry()), input_cost_per_million=Decimal("1.90"), output_cost_per_million=Decimal("8.00"), cache_read_cost_per_million=Decimal("0.38"), source="official_docs_snapshot", source_url="https://platform.kimi.ai/docs/pricing/chat-k27-code", pricing_version="moonshot-pricing-2026-09-04",
)
_OFFICIAL_DOCS_PRICING[('moonshot', 'kimi-k2.6')] = replace(
    _OFFICIAL_DOCS_PRICING.get(('moonshot', 'kimi-k2.6'), PricingEntry()), input_cost_per_million=Decimal("0.95"), output_cost_per_million=Decimal("4.00"), cache_read_cost_per_million=Decimal("0.16"), source="official_docs_snapshot", source_url="https://platform.kimi.ai/docs/pricing/chat-k26", pricing_version="moonshot-pricing-2026-09-04",
)
...
def resolve_billing_route(
    ...
    # Match the plan slug only so underlying-vendor counterfactual lookup can escape.
    if provider_name in {"kimi-coding", "kimi-coding-cn"}:
        return BillingRoute(provider=provider_name, model=bare, base_url=url, billing_mode="subscription_included")
...
def get_pricing_entry(
    model_name: str, provider: Optional[str] = None, base_url: Optional[str] = None,
    api_key: Optional[str] = None, *, ignore_subscription: bool = False,
) -> Optional[PricingEntry]:
    route = resolve_billing_route(model_name, provider=provider, base_url=base_url)
    if route.billing_mode == "subscription_included" and ignore_subscription:
        route = resolve_billing_route(
            model_name, provider=_SUBSCRIPTION_UNDERLYING_PROVIDER.get(route.provider, route.provider),
            base_url=base_url,
        )
