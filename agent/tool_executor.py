...
def _flush_session_db_after_tool_progress(agent, messages: list, *, stage: str) -> bool:
    ...
    from agent.conversation_loop import _maybe_inject_cron_time_note, _maybe_inject_run_budget_wrapup
    ...
    _maybe_inject_cron_time_note(agent, messages)  # cron sessions only (agent._cron_time_remaining)
