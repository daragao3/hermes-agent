...
class TurnFacadeMixin:
    ...
    def run_conversation(
        ...
        try:
            ...
            # source/model_config are NOT optional decoration: without them every auxiliary
            # call (vision, compression, titles) lands in session_model_usage with no source
            # and no model config, so aux spend cannot be attributed to the route that
            # incurred it. agent/title_generator.py already passes both.
