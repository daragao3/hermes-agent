...
if __import__("typing").TYPE_CHECKING:
    from tui_gateway.session_transports import (
    ...
    from tui_gateway.compute_host_bridge import (
        _metadata_mirror,
    )
    from tui_gateway.methods_voice import (
    ...
    from tui_gateway.session_history import (
    ...
    from tui_gateway.session_notifications import (
        _start_notification_poller,
    )
    from tui_gateway.session_reaper import (
        _flush_sessions_before_exit,
        _reap_idle_sessions,
    )
    from tui_gateway.session_workdir import (
        _completion_cwd,
    ...
    from tui_gateway.tool_progress import (
        _attach_todo_state,
        _session_todo_state,
...
from hermes_constants import (
    get_process_hermes_home, real_executable, get_hermes_home, get_hermes_home_override,
...
from tui_gateway.transport import (FanoutTransport, StdioTransport, Transport, bind_transport,  # noqa: F401  (split modules)
...
load_hermes_dotenv(hermes_home=_resolve_hermes_home(), project_env=Path(__file__).parent.parent / ".env")
...
def _thread_panic_hook(args):
    _record_crash("thread exception", args.exc_type, args.exc_value, args.exc_traceback,
