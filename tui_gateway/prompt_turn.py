...
if __import__("typing").TYPE_CHECKING:
    from tui_gateway.server import (
        ...
        Path,
        _GOAL_COMPRESSION_RECOVERY_ATTEMPTS,
        _GOAL_COMPRESSION_RECOVERY_LIMIT,
...
def _run_post_turn_followups(
    rid, sid: str, session: dict, result: Any, goal_followup: str | None, *, db_path=None) -> None:
...
def _drain_post_turn_notifications(rid, sid: str, session: dict, *, db_path=None) -> None:
    ...
    try:
        ...
        _notif_handle_ready(
            ...
            format_process_notification, deferred, owned=True, db_path=db_path)
...
def _run_prompt_submit(
    ...
    def run():
        ...
        goal_followup = None
        _turn_db_path = _capture_notification_db_path()
        try:
        ...
        _run_post_turn_followups(rid, sid, session, st.result, goal_followup, db_path=_turn_db_path)
