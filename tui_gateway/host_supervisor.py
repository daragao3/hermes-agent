...
def append_log_record(path: str | Path, record: str) -> None:
    ...
    # Windows CRT append performs seek+write; sibling threads can otherwise
    # overwrite records even though each record uses one os.write call.
...
class HostSupervisor:
    ...
    def __init__(
        ...
        # Resolve the real interpreter so Store Python AppX aliases cannot strand the child.
