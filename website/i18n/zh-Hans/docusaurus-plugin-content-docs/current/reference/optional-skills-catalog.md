...
| 技能 | 描述 |
|-------|-------------|
| [**baoyu-article-illustrator**](/user-guide/skills/optional/creative/creative-baoyu-article-illustrator) | 文章配图：类型 × 风格 × 配色的一致性。 |
| [**baoyu-comic**](/user-guide/skills/optional/creative/creative-baoyu-comic) | 知识漫画：科普、人物传记、教程。 |
| [**blender-mcp**](/user-guide/skills/optional/creative/creative-blender-mcp) | 通过目录中的 blender MCP 驱动 Blender，并附带 bpy 配方。 |
...
| [**creative-ideation**](/user-guide/skills/optional/creative/creative-creative-ideation) | 通过创意实践中的具名方法生成创意。 |
