...
def _is_blocked_device_path(path: str) -> bool:
    ...
    if os.sep == "\\":
        # On Windows the read I/O shells through Git Bash, whose MSYS layer emulates /dev/* and
        # /proc/* — normpath's backslashes must not let those aliases slip past the POSIX-string
        # comparisons below. Drive-qualified paths (C:\\dev\\zero) keep their prefix and still
