...
class ProcessCheckpointMixin:
    ...
    def _write_checkpoint(self, extra_entries: Optional[List[Dict[str, Any]]] = None, *, checkpoint_path: Optional[Path] = None):
    ...
    def recover_from_checkpoint(self) -> int:
        ...
        from tools.process_registry import (
            _checkpoint_path, ProcessSession, _CHECKPOINT_FIELDS,
        ...
        for entry in entries:
            ...
            session = ProcessSession(id=entry["session_id"], detached=True, checkpoint_path=checkpoint, **fields)
            with self._lock:
