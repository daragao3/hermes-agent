...
from tools.tts_tool_delivery import (  # noqa: F401 — re-export: tests import these provider fns from tts_tool
    _resolve_max_text_length, _build_audio_delivery_files, _convert_to_opus, _remove_quietly,  # noqa: F401 — re-export: tests import these provider fns from tts_tool
    _repair_ogg_container, _resolve_audio_delivery_profile, _split_text_for_tts)  # noqa: F401 — re-export: tests import these provider fns from tts_tool
from tools.tts_tool_providers import (  # noqa: F401 — re-export: tests import these provider fns from tts_tool
    _generate_edge_tts, _generate_elevenlabs, _generate_gemini_tts, _generate_minimax_tts,  # noqa: F401 — re-export: tests import these provider fns from tts_tool
    _generate_mistral_tts, _generate_xai_tts, _resolve_minimax_tts_runtime)  # noqa: F401 — re-export: tests import these provider fns from tts_tool
from tools.tts_tool_local import _generate_kittentts, _generate_neutts, _generate_piper_tts  # noqa: F401 — re-export: tests import these provider fns from tts_tool
from tools.tts_tool_plugins import (  # noqa: F401 — re-export: tests import these provider fns from tts_tool
    _dispatch_to_plugin_provider, _plugin_provider_is_available,  # noqa: F401 — re-export: tests import these provider fns from tts_tool
    _plugin_provider_is_voice_compatible)  # noqa: F401 — re-export: tests import these provider fns from tts_tool
from tools.tts_tool_openai import _generate_deepinfra_tts, _generate_openai_tts, _has_openai_audio_backend  # noqa: F401 — re-export: tests import these provider fns from tts_tool
...
def _session_platform() -> tuple:
    ...
    session_platform = get_session_env("HERMES_SESSION_PLATFORM", "").lower()
    return session_platform, session_platform in OPUS_VOICE_PLATFORMS
...
def text_to_speech_tool(
    ...
    session_platform, want_opus = _session_platform()
    delivery_profile = _resolve_audio_delivery_profile(session_platform, tts_config)
