...
async def _send_to_platform(platform, pconfig, chat_id, message, thread_id=None, media_files=None, force_document=False, args=None, *, buttons=None):
    ...
    if platform == Platform.TELEGRAM:
        return await _send_telegram(
            ...
            disable_link_previews=bool(getattr(pconfig, "extra", {}) and pconfig.extra.get("disable_link_previews")), buttons=buttons)
    from gateway.platforms.base import BasePlatformAdapter
