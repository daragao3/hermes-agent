...
from tools.tool_backend_helpers import coerce_modal_mode, managed_nous_tools_enabled as managed_nous_tools_enabled
...
def _capture_env_scratch_dir() -> None:
...
def _atexit_cleanup():
    ...
    if _active_environments:
        ...
        cleanup_all_environments(scratch_dir=_env_scratch_dir, _sweep_orphans=_env_scratch_dir is not None)
