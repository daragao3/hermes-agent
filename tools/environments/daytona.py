...
class DaytonaEnvironment(BaseEnvironment):
    ...
    def _daytona_upload(self, host_path: str, remote_path: str) -> None:
        # posixpath, not Path(...).parent: the sandbox is POSIX regardless of the controller's OS.
        self._sandbox.process.exec(quoted_mkdir_command([posixpath.dirname(remote_path) or "."]))
