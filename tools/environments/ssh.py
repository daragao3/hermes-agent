...
class SSHEnvironment(BaseEnvironment):
    ...
    def _scp_upload(self, host_path: str, remote_path: str) -> None:
        ...
        # posixpath, not Path(...).parent: the remote is POSIX regardless of the controller's OS.
        self._run_ssh(f"mkdir -p {shlex.quote(posixpath.dirname(remote_path) or '.')}", timeout=10)
