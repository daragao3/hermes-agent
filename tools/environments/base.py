...
def _register_inflight(env: "BaseEnvironment", proc: "ProcessHandle", *, thread_id: int | None = None) -> int:
    ...
    def execute(
        ...
        *,
        ...
        def _spawn_and_wait() -> dict:
            ...
            # The deadline worker waits, but the originating tool thread owns cancellation.
            owner_tid = _register_inflight(self, spawned, thread_id=parent_tid)
            try:
                ...
                _unregister_inflight(owner_tid, self, spawned)
