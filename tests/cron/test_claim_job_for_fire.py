...
def test_stale_fire_owner_cannot_mark_replacement_run(temp_home):
    ...
    # mark_job_run returns the stamped timestamp (or None) in this fork, not True/False --
    # scheduler.py keeps that string as deadline_last_run_at. "Discarded" is the falsy result.
