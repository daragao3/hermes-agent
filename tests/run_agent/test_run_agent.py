...
class TestExtractReasoning:
    ...
    @pytest.mark.parametrize(
        "reasoning, expected",
        [({"a": 1}, None), (["x"], "x"), (5, None), (object(), None),
         ([object()], None), ([MagicMock(), "valid text"], "valid text")],
    )
    def test_reasoning_types_preserve_text_and_skip_invalid_values(self, agent, reasoning, expected):
        # Upstream supports text lists; local invalid-object protection still applies.
        msg = _mock_assistant_msg(reasoning=reasoning)
