"""Run existing desktop sidebar_integration contracts under the isolated canonical runner."""
import json
import subprocess
import pytest
...
@pytest.mark.parametrize("spec", [
    "src/app/chat/sidebar/index.test.tsx",
    "src/app/chat/sidebar/chat-sidebar.integration.test.tsx",
])
@pytest.mark.timeout(85)
def test_desktop_sidebar_integration_contracts(tmp_path, spec):
    ...
    print("Desktop sidebar_integration cases passed:", data["numPassedTests"])
