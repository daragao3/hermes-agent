...
from unittest.mock import AsyncMock, patch as patch

import pytest
from aiohttp import web
from aiohttp.test_utils import TestClient, TestServer

from gateway.config import Platform as Platform, PlatformConfig
from plugins.platforms.raft.adapter import (
    ...
    DEFAULT_PATH,
    RaftAdapter,
    _ACTIVE_ADAPTERS as _ACTIVE_ADAPTERS,
    _ACTIVE_ADAPTERS_LOCK as _ACTIVE_ADAPTERS_LOCK,
    _RAFT_CONTEXT_LOCK as _RAFT_CONTEXT_LOCK,
    _RAFT_PROMPT_TURN_IDS as _RAFT_PROMPT_TURN_IDS,
    _RAFT_SESSION_IDS as _RAFT_SESSION_IDS,
    _RAFT_TURN_IDS as _RAFT_TURN_IDS,
    _has_content_field,
    _env_enablement,
    _is_connected as _is_connected,
    _on_session_start as _on_session_start,
    _on_pre_llm_call as _on_pre_llm_call,
    _on_pre_tool_call as _on_pre_tool_call,
    _on_post_llm_call as _on_post_llm_call,
    _on_post_tool_call as _on_post_tool_call,
    _on_session_end as _on_session_end,
    _on_session_finalize as _on_session_finalize,
    interactive_setup,
    register,
)
from gateway.session import build_session_key as build_session_key
