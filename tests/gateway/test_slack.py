...
from gateway.platforms.base import (
    SUPPORTED_VIDEO_TYPES as SUPPORTED_VIDEO_TYPES,
    SendResult as SendResult,
    is_host_excluded_by_no_proxy as is_host_excluded_by_no_proxy,
)
from gateway.platforms.event import MessageEvent as MessageEvent, MessageType
...
class TestMessageSplitting:
    ...
    async def test_send_passes_unfurl_options_to_every_chunk(self, adapter):
        ...
        for posted_call in adapter._app.client.chat_postMessage.call_args_list:
            assert posted_call.kwargs["unfurl_links"] is False
            assert posted_call.kwargs["unfurl_media"] is False
