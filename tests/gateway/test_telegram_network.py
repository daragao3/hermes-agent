...
class TestFallbackTransportInit:
    ...
    def test_forwards_limits_to_inner_transports(self, monkeypatch):
        ...
        # Bound, not discarded: the lazy-fallback assertion below calls _get_fallback on
        # it. Upstream's copy drops the assignment and raises NameError instead (their F
        # group is not gated).
