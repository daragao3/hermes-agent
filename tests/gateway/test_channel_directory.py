...
from gateway.channel_directory import (
    ...
    load_directory,
    _apply_channel_aliases as _apply_channel_aliases,
    _build_from_sessions,
    _build_slack,
    _slack_directory_warning_last as _slack_directory_warning_last,
)
...
class TestBuildChannelDirectoryOffload:
    ...
    def test_directory_write_runs_off_event_loop_thread(self, tmp_path):
        ...
        with patch("utils.atomic_json_write", side_effect=fake_write), \
