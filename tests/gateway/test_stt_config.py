...
from unittest.mock import AsyncMock as AsyncMock, patch

import pytest
import yaml

from gateway.config import GatewayConfig, Platform as Platform, load_gateway_config
from gateway.platforms.event import MessageEvent as MessageEvent, MessageType as MessageType
from gateway.session import SessionSource as SessionSource
