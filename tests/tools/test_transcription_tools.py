...
class TestTranscribeLocalCommand:
    ...
    def test_local_whisper_subprocess_uses_sanitized_env(
        ...
        monkeypatch.setattr("hermes_cli._subprocess_compat.run_text_capture", fake_run)
        monkeypatch.setattr(
...
class TestShellSafety:
    ...
    def test_env_var_template_metacharacters_are_literal_argv(
        ...
        # run_text_capture owns file-backed stdout/stderr and Windows hiding;
        # this call site supplies only its semantic timeout/stdin contract.
