...
class TestLegacyKillProcessTree:
    ...
    def test_posix_kills_process_group_term_then_kill(self, monkeypatch):
        ...
        assert killpg_calls == [(999, signal.SIGTERM), (999, signal.SIGKILL)]  # windows-footgun: ok -- asserts recorded fake-call args; nothing is signalled
    ...
    def test_posix_sigterm_permission_denied_does_not_attempt_sigkill(self, monkeypatch):
        ...
        monkeypatch.setattr("os.killpg", fake_killpg)  # windows-footgun: ok -- patch target name, never invoked on Windows
