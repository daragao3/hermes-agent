...
def _run_with_env(extra_os_env=None, self_env=None):
    ...
    # Import the command-preparation dependencies under the isolated test home,
    # before replacing the entire process environment with the policy fixture.
...
class TestPythonpathSelectiveStrip:
    ...
    def test_base_python_sanitizer_uses_validated_separate_runtime_venv(self, tmp_path, monkeypatch):
        ...
        from tools.environments import local_pythonpath as local_pythonpath
