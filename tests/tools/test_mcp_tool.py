...
class TestMCPStatus:
    ...
    def test_scoped_shutdown_clears_only_its_connection_status(self, monkeypatch):
        import tools.mcp_tool as mcp_tool
        from tools import mcp_tool_lifecycle, mcp_tool_loop, mcp_tool_discovery as mcp_tool_discovery
...
class TestBuildSafeEnv:
    ...
    def test_windows_location_vars_passed_without_secrets(self):
        ...
        # Windows os.environ normalizes names to uppercase.
...
from tools.mcp_tool import CreateMessageResultWithTools, SamplingHandler, SamplingToolsCapability as SamplingToolsCapability, ToolUseContent
...
class TestRegisterMcpServers:
    ...
    def test_clears_stale_connecting_on_timeout(self):
        ...
        from tools.mcp_tool_discovery import register_mcp_servers
        from tools.mcp_tool import _servers, _server_connecting, _server_connect_errors as _server_connect_errors
        from tools.mcp_tool_loop import _ensure_mcp_loop
...
class TestMCPDiscoveryCrossProcessLock:
    ...
    def test_lock_acquired_path(self, tmp_path):
        ...
        with patch.object(cookie, "release", wraps=cookie.release) as release_spy:
            with patch("tools.mcp_tool_loop._try_acquire_mcp_discovery_lock", mock_acquire), \
                 ...
                 patch("tools.mcp_tool_discovery.register_mcp_servers", return_value=["mcp__test_srv__ping"]) as _reg_spy:
                result = discover_mcp_tools()
    ...
    def test_lock_held_retries_exhausted_fallback(self):
        ...
        from tools.mcp_tool import _LOCK_UNAVAILABLE as _LOCK_UNAVAILABLE, _MCP_DISCOVERY_LOCK_MAX_RETRIES as _MCP_DISCOVERY_LOCK_MAX_RETRIES
        from tools.mcp_tool_discovery import discover_mcp_tools
