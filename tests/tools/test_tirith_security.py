...
@pytest.fixture
def supported_tirith_binary(monkeypatch):
    """Model a supported binary for mocked scanner/install contracts only."""
...
@pytest.mark.usefixtures("supported_tirith_binary")
...
class TestMkdtempOSErrorNoSpace:
    ...
    def test_mkdtemp_oserror_returns_no_space(self, monkeypatch):
    ...
    def test_mkdtemp_oserror_does_not_leak_tempdir(self, monkeypatch):
        monkeypatch.setattr(_tirith_mod, "_detect_target", lambda: "x86_64-unknown-linux-gnu")
