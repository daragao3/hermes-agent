...
# fcntl is POSIX-only and this module is about real flock contention, so the whole file is
# POSIX. importorskip makes that a SKIP; a bare top-level import is a collection ERROR on
# Windows, which takes the module down instead of reporting it as not applicable.
