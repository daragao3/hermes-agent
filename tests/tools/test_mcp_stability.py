...
class TestStdioPidTracking:
    ...
    def test_run_stdio_reaps_orphans_before_spawn(self):
        ...
        from tools.mcp_tool_lifecycle import (
            _kill_orphaned_mcp_children as _kill_orphaned_mcp_children, _orphan_stdio_pids, _stdio_pids as _stdio_pids, _stdio_pgids as _stdio_pgids)
...
class TestStdioPgroupReaping:
    ...
    def test_no_pgid_uses_per_pid_kill(self, monkeypatch):
        ...
        from tools.mcp_tool_lifecycle import _kill_orphaned_mcp_children, _orphan_stdio_pids, _stdio_pgids as _stdio_pgids
        from tools.mcp_tool import _lock
