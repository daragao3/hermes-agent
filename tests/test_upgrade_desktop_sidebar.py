"""Run existing desktop sidebar contracts under the isolated canonical runner."""
import json
import pytest
...
def test_desktop_sidebar_contracts(tmp_path):
    ...
    result = run_text_capture([
        ...
        "src/app/chat/sidebar/virtual-session-list.test.tsx",
        "src/app/chat/sidebar/session-date-sections.test.ts",
    ...
    print("Desktop sidebar cases passed:", data["numPassedTests"])
