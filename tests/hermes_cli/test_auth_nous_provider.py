...
from hermes_cli.auth import AuthError, get_provider_auth_state as get_provider_auth_state, resolve_nous_runtime_credentials as resolve_nous_runtime_credentials
...
def test_shared_store_posix_permissions(shared_store_env):
    from hermes_cli.auth import _nous_shared_store_path, _write_shared_nous_state

    _write_shared_nous_state(_full_state_fixture())
    mode = _nous_shared_store_path().stat().st_mode & 0o777
    assert mode == 0o600 or mode == 0o644
