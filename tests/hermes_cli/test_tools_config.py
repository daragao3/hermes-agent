...
from hermes_cli.tools_config import (
    ...
    _apply_toolset_change as _apply_toolset_change,
    _checklist_toolset_keys,
    _configure_provider as _configure_provider,
    _reconfigure_provider as _reconfigure_provider,
    _get_platform_tools,
    _platform_toolset_summary as _platform_toolset_summary,
    _reconfigure_tool as _reconfigure_tool,
    _run_post_setup,
    _save_platform_tools,
    _toolset_has_keys,
    _toolset_needs_configuration_prompt as _toolset_needs_configuration_prompt,
    CONFIGURABLE_TOOLSETS,
    TOOL_CATEGORIES,
    gui_toolset_label as gui_toolset_label,
    _visible_providers,
    provider_readiness_status as provider_readiness_status,
    tools_command,
)
...
class TestAgentBrowserPostSetup:
    ...
    def _stub_browser_use_install(self):
        ...
        with patch("hermes_cli.tools_config_post_setup._ensure_browser_use_cli") as stub, \
             patch("subprocess.Popen", side_effect=AssertionError("unmocked browser installer")):
            yield stub
    ...
    def test_installs_chromium_via_npx_when_no_local_binary_resolved(self):
        ...
        with patch(
            ...
            "tools.browser_tool_install.node_tool_runnable", return_value=True
        ), patch("hermes_cli._subprocess_compat.run_text_capture") as run, patch(
            "tools.browser_tool_install._chromium_installed", return_value=False
        ), patch(
