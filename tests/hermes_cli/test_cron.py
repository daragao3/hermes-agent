...
class TestSlashCronListLastStatus:
    ...
    def test_delivery_failed_names_the_delivery_error(self, tmp_cron_dir, capsys):
        ...
        # Upstream renamed the slash row: last_run_at is stamped when the run FINISHES.
        assert "Last completed: 2026-09-01T07:00:00+00:00 (delivery_failed: telegram: 502 Bad Gateway)" in out
