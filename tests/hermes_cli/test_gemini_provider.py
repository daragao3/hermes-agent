...
from hermes_cli.models import _PROVIDER_MODELS, _PROVIDER_LABELS as _PROVIDER_LABELS, _PROVIDER_ALIASES, normalize_provider
from hermes_cli.model_normalize import normalize_model_for_provider, detect_vendor
from agent.model_metadata import get_model_context_length
from agent.models_dev import PROVIDER_TO_MODELS_DEV, list_agentic_models, _NOISE_PATTERNS as _NOISE_PATTERNS
# Charge the real agent's cold imports to the file's collection budget, not
# the first initialization assertion's 30-second execution budget.
