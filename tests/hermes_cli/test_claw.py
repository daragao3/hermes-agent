...
class TestDetectOpenclawProcesses:
    # The systemctl + pgrep probes are the POSIX branch; win32 takes tasklist/powershell
    # (test_returns_empty_on_windows_when_nothing_found covers that arm).
    @pytest.mark.skipif(sys.platform == "win32", reason="POSIX pgrep/systemctl branch")
