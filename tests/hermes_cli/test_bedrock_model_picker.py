...
class TestBedrockRegionRouting:
    ...
    # Asserts on the discovered (mocked) catalog reaching the picker; opt out of the hermes_cli
    # conftest stub that defaults cached_provider_model_ids to [] (curated us.* fallback).
