...
from hermes_constants import (
    ...
    find_node_executable_on_path as find_node_executable_on_path,
    ...
    reset_hermes_home_override as reset_hermes_home_override,
    secure_parent_dir,
    set_hermes_home_override as set_hermes_home_override,
    with_hermes_node_path as with_hermes_node_path,
)
...
class TestNodeExecutablePresent:
    ...
    These file-presence checks run on Windows. POSIX executable-bit behavior
    is covered by the neighbouring managed-node tests.
    """
