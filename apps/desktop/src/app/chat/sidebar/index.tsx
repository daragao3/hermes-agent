...
export function ChatSidebar({
  ...
  // THE THIRD EMPTY STATE -- see sidebar/scoped-empty.ts for why it exists and why it is
  // this narrow. Computed from the cross-profile map, the only one carrying a comparison
  ...
  const scopedEmptyWithRowsElsewhere =
    !inProject &&
    !filtersActive &&
    isScopedEmptyWithRowsElsewhere({
      allProfileTotals: sessionAllProfileTotals,
      scope: profileScope,
      scopedTotal: undefined,
      visibleCount: displayAgentSessions.length
    })
