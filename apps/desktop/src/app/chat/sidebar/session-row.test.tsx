...
// Partial: the row also reads the session-bridge badge helpers (bridgeProviderLabel
// etc.) from this module; a bare two-key mock would throw on those imports.
vi.mock('@/lib/session-source', async importOriginal => {
  const actual = await importOriginal<typeof import('@/lib/session-source')>()
