      ...
      >
        ...
        >
          {(() => {
            ...
            // Session-bridge badges (fork): which harness drove a local session, and
            // the mirror / sidebar state of a bridged one. One harness badge per row --
            // the driver badge is suppressed when a bridge provider is present.
            const bridgeBadges = (
              <>
                {bridgeProvider ? (
                  <span
