...
export function wipeSessionListsForGatewaySwitch(): void {
  ...
  setSessionProfilesTruncated({})
  setSessionProfilesUsage({})
  // Counts belong to the backend we just left: keeping them would let the old machine's
  // profiles answer "your chats are over there" about a gateway that has never been read.
  setSessionAllProfileTotals({})
  setCronSessions([])
