...
vi.mock('@/lib/shiki-core', () => ({
  normalizeShikiLang: (language: string) => language || 'text',
  getCuratedHighlighter: vi.fn(async () => ({
    codeToHtml: (code: string) => codeToHtml(code),
    getLoadedThemes: () => ['github-dark-dimmed', 'github-light-default', 'github-dark-default'],
