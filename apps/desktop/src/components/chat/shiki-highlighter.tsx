 ...
 *
 * The heavy lifting lives in the lazy `shiki-block` chunk (the curated language set falls back to plain text for other languages;
 * theme switches follow the document `color-scheme`
