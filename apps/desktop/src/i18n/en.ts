...
export const en: Translations = {
  ...
  cron: {
    ...
    next: 'Next',
    noRuns: 'No runs yet',
    runsFailed: 'Run history failed to load',
    runsStale: 'Refresh failed — showing the last successful load',
    jobsPartial: profiles => `Some jobs could not be read (${profiles})`,
    retry: 'Retry',
    manage: 'Manage',
    showRuns: 'Show runs',
    hideRuns: 'Hide runs',
