...
// The repo-wide install guard (scripts/js/assert-workspace-install.mjs) is
// shared by every workspace; vitest.globalSetup.mjs imports it from this path,
// so it stays reachable here. `checkRootInstall` deliberately NOT re-exported:
// this file's own (appDir, rootDir) form is the one the test above pins.
export {
  checkLockDrift,
