...
#
# The registry's plugin_entries()/all_entries() accessors call _resolve_all(), which imports every
# bundled adapter and therefore every platform SDK. These helpers answer the same questions from
# registry METADATA, and resolve only the platforms that could plausibly matter.
