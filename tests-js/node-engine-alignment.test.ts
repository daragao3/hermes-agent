...
describe('Node engine alignment', () => {
  ...
  test.each(['22.22.2', '22.23.1', '24.15.0', '24.18.2', '26.0.0'])('all workspace manifests accept supported Node %s', version => {
    assert.ok(satisfiesRange(version, rootRange))
    assert.ok(satisfiesRange(version, desktopRange))
  })

  test.each(['22.21.1', '22.22.1', '23.0.0', '24.0.0', '24.14.9', '25.2.1'])(
