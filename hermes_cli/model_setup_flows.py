...
# Re-exported, not used here: hermes_cli/main.py imports all four FROM this module (its own
# import is a parenthesised multi-line block, which is why a line-oriented search for the
# importer comes back empty). Deleting them as 'unused' breaks the CLI at import time.
from hermes_cli.model_setup_flows_custom import (  # noqa: F401 — re-export for hermes_cli.main
    _model_flow_custom, _model_flow_named_custom)
from hermes_cli.model_setup_flows_azure import _model_flow_azure_foundry  # noqa: F401 — re-export
from hermes_cli.model_setup_flows_bedrock import _model_flow_bedrock  # noqa: F401 — re-export
