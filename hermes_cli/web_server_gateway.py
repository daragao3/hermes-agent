...
from hermes_cli.config import get_hermes_home as get_hermes_home, get_process_hermes_home
...
def _action_log_dir() -> Path:
    """Resolve process-owned action logs at call time, with an optional override."""
