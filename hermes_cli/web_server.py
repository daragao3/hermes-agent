...
from hermes_cli import __version__, __release_date__ as __release_date__
...
from hermes_cli.web_server_cron import _start_desktop_cron_ticker  # noqa: E402
    ...
    async def _serve():
        ...
        with server.capture_signals():
            try:
                ...
                # Uvicorn's non-propagating logger may only reach discarded stderr.
                # Keep durable Hermes diagnostics; _run_serve owns bind exit translation.
                _log.error("Dashboard server could not start on %s:%s (exit=%s)",
                           host, port, exc.code)
                raise
...
_PLUGIN_COMPAT_LAZY.update({'_machine_gateway_alive': ('hermes_cli.web_server_cron', '_machine_gateway_alive'), '_gateway_heartbeat_owner_alive': ('hermes_cli.web_server_cron', '_gateway_heartbeat_owner_alive'), '_GATEWAY_HEARTBEAT_FRESH_SECONDS': ('hermes_cli.web_server_cron', '_GATEWAY_HEARTBEAT_FRESH_SECONDS'), '_GATEWAY_SILENT_OWNER_HOLD_TICKS': ('hermes_cli.web_server_cron', '_GATEWAY_SILENT_OWNER_HOLD_TICKS'), '_action_log_dir': ('hermes_cli.web_server_gateway', '_action_log_dir'), '_oauth_session_home': ('hermes_cli.web_server_oauth', '_oauth_session_home'), '_add_bridge_metadata_to_sessions': ('hermes_cli.web_server_sessions', '_add_bridge_metadata_to_sessions'), '_dashboard_console_context': ('hermes_cli.web_routers.chat_ws', '_dashboard_console_context')})
