...
@doctor_check()
def _check_npm_audit(should_fix: bool, f: Finding, *, on_demand: bool = False) -> None:
    ...
    if npm_bin and not on_demand:
        check_info("npm dependency audits skipped — run hermes doctor --audit to check them.")
    if npm_bin and on_demand:
        try:
