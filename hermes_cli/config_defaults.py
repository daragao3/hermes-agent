...
DEFAULT_CONFIG = {
    ...
    "session_bridge": {
        "sidebar": {
            # _profile_safe_hermes_home_string lives in config.py; importing it here
            # would be circular. effective_default_config() overwrites this key on every
            # call, which is the entire reason that function exists.
            "inbox_cwd": "",
