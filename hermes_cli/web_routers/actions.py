...
def _record_completed_action(name: str, message: str, exit_code: int = 1) -> None:
    ...
    # Through the resolver, not the raw module attribute: that attribute is None unless
    # something pinned it, and None means "resolve live from the process home".
    from hermes_cli.web_server_gateway import _action_log_dir
