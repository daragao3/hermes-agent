...
def _worktree_add(repo_root: str, wt_path: Path, branch_name: str, base_ref: str, base_label: str):
    ...
    def _add(cfg):
        # File-backed capture keeps inherited Windows pipes from defeating the timeout.
        from hermes_cli._subprocess_compat import run_text_capture
        return run_text_capture(["git", *cfg, "worktree", "add", str(wt_path), "-b", branch_name, base_ref],
                                cwd=repo_root, timeout=300, stdin=subprocess.DEVNULL,
