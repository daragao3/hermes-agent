...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("ddp-approve", "Stage a human approval for one TRIAGED DevFlow request", "Session",
               gateway_only=True, aliases=("ddp_approve",), args_hint="<request-id> <evidence>", busy_policy="dispatch"),
    CommandDef("ddp-decline", "Stage a human decline for one TRIAGED DevFlow request", "Session",
               gateway_only=True, aliases=("ddp_decline",), args_hint="<request-id> <evidence>", busy_policy="dispatch"),
    CommandDef("ddp-approve-confirm", "Confirm one staged DevFlow approval", "Session",
               gateway_only=True, aliases=("ddp_approve_confirm",), args_hint="<confirmation-token>", busy_policy="dispatch"),
    CommandDef("ddp-decline-confirm", "Confirm one staged DevFlow decline", "Session",
               gateway_only=True, aliases=("ddp_decline_confirm",), args_hint="<confirmation-token>", busy_policy="dispatch"),
    CommandDef("devflow-login", "Get a one-time code to sign in to DevFlow Mission Control (:3040)",
               "Session", gateway_only=True, aliases=("devflow_login",), busy_policy="dispatch"),
