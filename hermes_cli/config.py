...
DEFAULT_CONFIG["session_bridge"]["sidebar"]["inbox_cwd"] = _profile_safe_hermes_home_string()
...
def save_config(
    ...
    preserve_keys: Optional[Set[Tuple[str, ...]]] = None, merge_existing: bool = False) -> bool:
