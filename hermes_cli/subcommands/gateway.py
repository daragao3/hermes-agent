...
def build_gateway_parser(
    ...
    gateway_run.add_argument(
        "--reason",
        help="Why the gateway is being bounced (e.g. the commit being deployed). Recorded "
            "on the loops restart claim gateway-restart-<stamp> that this command opens "
            "before stopping the incumbent, so other sessions can see who bounced it, when, "
            "and why.")
    _flag(
