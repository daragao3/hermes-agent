...
def build_doctor_parser(subparsers, *, cmd_doctor: Callable) -> None:
    ...
    doctor_parser.add_argument(
        ...
        help="Run optional npm dependency audits (timeout: HERMES_DOCTOR_NPM_AUDIT_TIMEOUT).")
    doctor_parser.add_argument(
        "--deep", action="store_true",
        help="Verify the full-text index against every message; may take minutes on large databases.")
