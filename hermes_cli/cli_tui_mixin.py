...
class CLITuiMixin:
    ...
    def _tui_enter_while_busy(self, text: str, images: list, payload) -> None:
        ...
        """
        from cli import CLI_CONFIG, _ACCENT, _DIM, _RST, _cprint, _resolve_hermes_home
        ...
        if _effective_mode == "queue":
            ...
            if redirected:
                ...
                try:
                    with open(_resolve_hermes_home() / "interrupt_debug.log", "a", encoding="utf-8") as _f:
                        _f.write(
    ...
    def _tui_collapse_paste(self, text: str, line_count: int, *, fallback: bool) -> str:
        ...
        from cli import _resolve_hermes_home, datetime, logger
